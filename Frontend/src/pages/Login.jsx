    ...
    return (
        <div  className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-300 to-purple-400'>
            <img
                ...
                alt=""
            />
            <div data-aos="fade-left" className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form  onSubmit={onSubmitHandler}>
                    ...
                    <p onClick={() => navigate('/reset-password')} className='mb-4 cursor-pointer'>
                        Forgot Password?
                    </p>
